...
const checkStatus = async () => {
    ...
    if (newStatus !== currentStatus && previousStatus !== '') {
        ...
        logStateChange('NOTIFICATION_DECISION', {
            'Recent Status': recentNotification,
            'Last Sent Status': lastSentNotification,
            'Will Send': recentNotification !== lastSentNotification,
        ...
        if (recentNotification !== lastSentNotification) {
            ...
            notificationTimeout = setTimeout(async () => {
                ...
                if (recentNotification && recentNotification !== lastSentNotification) {
                    ...
                    log('Recent notification cleared');
                } else {
                    logStateChange('NOTIFICATION_SKIPPED', {
                        'Recent Status': recentNotification,
                        'Last Sent': lastSentNotification,
                        'Reason': recentNotification === lastSentNotification ? 'Duplicate notification' : 'Notification cleared'
                    });
                }
