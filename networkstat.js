...
const sendNotification = async (message) => {
    ...
    await notificationChannel.send(finalMessage);
    console.log('Notification sent:', finalMessage);
};

// Check whether to send a notification based on the status changes
const shouldSendNotification = (statusBeforeTimeout, newStatus, currentStatus) => {
    return !(statusBeforeTimeout === 'status_green' && 
             (newStatus === 'status_yellow' || newStatus === 'status_red') && 
...
const checkStatus = async () => {
    ...
    if (newStatus !== currentStatus) {
        ...
        notificationTimeout = setTimeout(async () => {
            if (latestNotification && shouldSendNotification(statusBeforeTimeout, newStatus, currentStatus)) {
